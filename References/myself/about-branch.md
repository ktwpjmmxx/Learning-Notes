...
code/: Stable Diffusion実装、カスタムモデル作成、プロンプトエンジニアリング実験
...
notebooks/01_basics/: トークナイザー実装、GPT基礎実験、ファインチューニング手順
...
articles/: 業界トレンド、技術解説記事の要約
books/: 専門書の読書ノート、重要概念整理
...
learning-roadmap.md: 技術習得の戦略的計画
...
成長軌跡: archive/ + CHANGELOG.md で技術進歩の可視化
